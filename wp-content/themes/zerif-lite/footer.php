...
<div class="container">
	...
	<?php
		...
		$zerif_socials_vk = get_theme_mod('zerif_socials_vk','#');
		...
		if( !empty($zerif_socials_facebook) || !empty($zerif_socials_vk) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble) || 
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					if(!empty($zerif_socials_facebook) || !empty($zerif_socials_vk) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble)):
						...
						/* vk */
						if( !empty($zerif_socials_vk) ):
							echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_vk).'"><i class="fa fa-vk"></i></a></li>';
						endif;
						/* twitter */
					...
					echo '<div class="zerif-copyright-box">Все материалы на сайте выложены автором исключительно с целью поделиться собственным опытом.<br>
					Автор не несет ответственности за действия пользователей, преведшие к травме или другому неожиданному исходу при попытке использования материалов сайта.
					Для воспроизведения на практике предложенной на сайте информации необходимы соответствующие навыки и знания.
					Читатель формума при попытке повторить приведенные на сайте конструкции должен понимать опасность электрического тока и последствия неправильного обращения с электричеством и электроприборами.
					Все действия по сборке, подключению к электричеству и эксплуатации приведенных на сайте схем посетитель сайта производит на свой страх и риск.
					</div>';
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter35760820 = new Ya.Metrika({
                    id:35760820,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/35760820" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
