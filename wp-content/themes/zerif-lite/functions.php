        ...
        <div class="col-lg-3 col-sm-3 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <div class="service-icon">
				...
				<?php if( !empty($instance['link']) ): ?>
					...
					<a href="<?php echo $instance['link']; ?>"><i class="pixeden" style="background:url(<?php echo esc_url($instance['image_uri']); ?>) no-repeat center;width:100%; height:100%; background-size: contain;"></i> <!-- FOCUS ICON--></a>
				
				<?php else: ?>
				
					<i class="pixeden" style="background:url(<?php echo esc_url($instance['image_uri']); ?>) no-repeat center;width:100%; height:100%; background-size: contain;"></i> <!-- FOCUS ICON-->
...
class zerif_team_widget extends WP_Widget{	
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('vk_link'); ?>"><?php _e('Vk link', 'zerif-lite'); ?></label><br/>
            <input type="text" name="<?php echo $this->get_field_name('vk_link'); ?>" id="<?php echo $this->get_field_id('vk_link'); ?>" value="<?php if( !empty($instance['vk_link']) ): echo $instance['vk_link']; endif; ?>" class="widefat">
        </p>
        <p>
