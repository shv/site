...
function zerif_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		/* vk */
		$wp_customize->add_setting( 'zerif_socials_vk', array(
			'sanitize_callback' => 'esc_url_raw',
			'default' => ''
		));
		
		$wp_customize->add_control( 'zerif_socials_vk', array(
			'label'    => __( 'Vk link', 'zerif-lite' ),
			'section'  => 'zerif_general_socials_section',
			'priority' => 4,
		));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature1_icon', array(
			'sanitize_callback' => 'esc_url_raw'
		));

		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_aboutus_feature1_icon', array(
			'label'    => __( 'Feature no1 - icon', 'zerif-lite' ),
			'section'  => 'zerif_aboutus_feat1_section',
			'priority' => 9,
		)));
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature2_icon', array(
			'sanitize_callback' => 'esc_url_raw'
		));

		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_aboutus_feature2_icon', array(
			'label'    => __( 'Feature no2 - icon', 'zerif-lite' ),
			'section'  => 'zerif_aboutus_feat2_section',
			'priority' => 19,
		)));
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature3_icon', array(
			'sanitize_callback' => 'esc_url_raw'
		));

		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_aboutus_feature3_icon', array(
			'label'    => __( 'Feature no3 - icon', 'zerif-lite' ),
			'section'  => 'zerif_aboutus_feat3_section',
			'priority' => 19,
		)));
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature4_icon', array(
			'sanitize_callback' => 'esc_url_raw'
		));

		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_aboutus_feature4_icon', array(
			'label'    => __( 'Feature no4 - icon', 'zerif-lite' ),
			'section'  => 'zerif_aboutus_feat4_section',
			'priority' => 19,
		)));
