<section class="about-us" id="aboutus">
	<div class="container">
		...
		<?php
			...
			$zerif_aboutus_feature1_icon	= get_theme_mod('zerif_aboutus_feature1_icon');
			$zerif_aboutus_feature2_icon	= get_theme_mod('zerif_aboutus_feature2_icon');
			$zerif_aboutus_feature3_icon	= get_theme_mod('zerif_aboutus_feature3_icon');
			$zerif_aboutus_feature4_icon	= get_theme_mod('zerif_aboutus_feature4_icon');
			...
			<ul class="skills" data-scrollreveal="enter right after 0s over 1s">
				...
				<li class="skill skill_1">
					...
					<?php
						...
						if( !empty($zerif_aboutus_feature1_icon) ):

							echo '<div class="skill-count focus-box">';

								echo '<div class="service-icon">';

									echo '<i class="pixeden" style="background:url('.esc_url($zerif_aboutus_feature1_icon).') no-repeat center; background-size: contain;"></i>';
				
        	    				echo '</div>';

							echo '</div>';

						elseif( !empty($zerif_aboutus_feature1_nr) ):
				...
				<li class="skill skill_2">
					...
					<?php
						...
						if( !empty($zerif_aboutus_feature2_icon) ):

							echo '<div class="skill-count focus-box">';

								echo '<div class="service-icon">';

									echo '<i class="pixeden" style="background:url('.esc_url($zerif_aboutus_feature2_icon).') no-repeat center; background-size: contain;"></i>';
				
        	    				echo '</div>';

							echo '</div>';

						elseif( !empty($zerif_aboutus_feature2_nr) ):
				...
				<li class="skill skill_3">
					...
					<?php
						...
						if( !empty($zerif_aboutus_feature3_icon) ):

							echo '<div class="skill-count focus-box">';

								echo '<div class="service-icon">';

									echo '<i class="pixeden" style="background:url('.esc_url($zerif_aboutus_feature3_icon).') no-repeat center; background-size: contain;"></i>';
				
        	    				echo '</div>';

							echo '</div>';

						elseif( !empty($zerif_aboutus_feature3_nr) ):
				...
				<li class="skill skill_4">
					...
					<?php
						...
						if( !empty($zerif_aboutus_feature4_icon) ):

							echo '<div class="skill-count focus-box">';

								echo '<div class="service-icon">';

									echo '<i class="pixeden" style="background:url('.esc_url($zerif_aboutus_feature4_icon).') no-repeat center; background-size: contain;"></i>';
				
        	    				echo '</div>';

							echo '</div>';

						elseif( !empty($zerif_aboutus_feature4_nr) ):
